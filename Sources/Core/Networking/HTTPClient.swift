...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw APIFreaksError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw APIFreaksError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: APIFreaksError?
                ...
                } else if let existingClientError = error as? APIFreaksError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw APIFreaksError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> APIFreaksError
    {
        ...
        return APIFreaksError.httpError(httpError)
    }
}
