...
public struct BulkCurrentWeatherResponseBulkItemCurrent: Codable, Hashable, Sendable {
    ...
    public let astronomy: BulkCurrentWeatherResponseBulkItemCurrentAstronomy
    /// Air quality metrics including pollutant concentrations and AQI values.
    public let airQuality: BulkCurrentWeatherResponseBulkItemCurrentAirQuality
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.astronomy = try container.decode(BulkCurrentWeatherResponseBulkItemCurrentAstronomy.self, forKey: .astronomy)
        self.airQuality = try container.decode(BulkCurrentWeatherResponseBulkItemCurrentAirQuality.self, forKey: .airQuality)
