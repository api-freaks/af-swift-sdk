...
public struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAddress: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAddressDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAddressDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        address: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAddressDnsType.self, forKey: .dnsType)
