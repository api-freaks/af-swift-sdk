...
public struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemOne: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemOneDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemOneDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        target: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemOneDnsType.self, forKey: .dnsType)
