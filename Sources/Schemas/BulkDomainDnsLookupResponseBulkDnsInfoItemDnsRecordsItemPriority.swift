...
public struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemPriority: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemPriorityDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemPriorityDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        target: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemPriorityDnsType.self, forKey: .dnsType)
