...
public struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemSingleName: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemSingleNameDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemSingleNameDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        singleName: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemSingleNameDnsType.self, forKey: .dnsType)
