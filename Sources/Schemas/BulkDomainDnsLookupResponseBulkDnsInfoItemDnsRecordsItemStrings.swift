...
public struct BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemStrings: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemStringsDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemStringsDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        strings: [String],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemStringsDnsType.self, forKey: .dnsType)
