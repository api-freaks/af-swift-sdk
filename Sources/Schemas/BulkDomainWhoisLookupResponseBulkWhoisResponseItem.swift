...
public struct BulkDomainWhoisLookupResponseBulkWhoisResponseItem: Codable, Hashable, Sendable {
    ...
    public let domainRegistrar: BulkDomainWhoisLookupResponseBulkWhoisResponseItemDomainRegistrar?
    public let resellerContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact?
    public let registrantContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistrantContact?
    public let administrativeContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemAdministrativeContact?
    public let technicalContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact?
    public let billingContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemBillingContact?
    public let nameServers: [String]?
    public let domainStatus: [String]?
    public let whoisRawDomain: String?
    public let registryData: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryData?
    ...
    public init(
        ...
        domainRegistrar: BulkDomainWhoisLookupResponseBulkWhoisResponseItemDomainRegistrar? = nil,
        resellerContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact? = nil,
        registrantContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistrantContact? = nil,
        administrativeContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemAdministrativeContact? = nil,
        technicalContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact? = nil,
        billingContact: BulkDomainWhoisLookupResponseBulkWhoisResponseItemBillingContact? = nil,
        nameServers: [String]? = nil,
        domainStatus: [String]? = nil,
        whoisRawDomain: String? = nil,
        registryData: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryData? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.domainRegistrar = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemDomainRegistrar.self, forKey: .domainRegistrar)
        self.resellerContact = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemResellerContact.self, forKey: .resellerContact)
        self.registrantContact = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistrantContact.self, forKey: .registrantContact)
        self.administrativeContact = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemAdministrativeContact.self, forKey: .administrativeContact)
        self.technicalContact = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemTechnicalContact.self, forKey: .technicalContact)
        self.billingContact = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemBillingContact.self, forKey: .billingContact)
        ...
        self.registryData = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryData.self, forKey: .registryData)
