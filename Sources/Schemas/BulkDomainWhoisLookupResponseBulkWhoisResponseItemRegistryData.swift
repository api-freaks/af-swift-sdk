...
public struct BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryData: Codable, Hashable, Sendable {
    public let domainName: String?
    public let queryTime: Date?
    public let whoisServer: String?
    public let domainRegistered: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistered?
    ...
    public let domainRegistrar: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrar?
    ...
    public init(
        ...
        domainRegistered: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistered? = nil,
        ...
        domainRegistrar: BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrar? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.domainRegistered = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistered.self, forKey: .domainRegistered)
        ...
        self.domainRegistrar = try container.decodeIfPresent(BulkDomainWhoisLookupResponseBulkWhoisResponseItemRegistryDataDomainRegistrar.self, forKey: .domainRegistrar)
