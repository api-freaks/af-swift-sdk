...
public struct BulkGeolocationLookupResponseItemTimeZone: Codable, Hashable, Sendable {
    ...
    public let dstStart: BulkGeolocationLookupResponseItemTimeZoneDstStart?
    public let dstEnd: BulkGeolocationLookupResponseItemTimeZoneDstEnd?
    ...
    public init(
        ...
        dstStart: BulkGeolocationLookupResponseItemTimeZoneDstStart? = nil,
        dstEnd: BulkGeolocationLookupResponseItemTimeZoneDstEnd? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dstStart = try container.decodeIfPresent(BulkGeolocationLookupResponseItemTimeZoneDstStart.self, forKey: .dstStart)
        self.dstEnd = try container.decodeIfPresent(BulkGeolocationLookupResponseItemTimeZoneDstEnd.self, forKey: .dstEnd)
