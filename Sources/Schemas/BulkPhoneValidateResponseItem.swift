...
public struct BulkPhoneValidateResponseItem: Codable, Hashable, Sendable {
    /// The original request data provided by the client.
    public let rawInput: BulkPhoneValidateResponseItemRawInput?
    ...
    public let lineType: BulkPhoneValidateResponseItemLineType?
    /// The number represented in four standardized formats. Only returned for valid numbers.
    public let formats: BulkPhoneValidateResponseItemFormats?
    ...
    public init(
        rawInput: BulkPhoneValidateResponseItemRawInput? = nil,
        possible: Bool? = nil,
        valid: Bool? = nil,
        ...
        lineType: BulkPhoneValidateResponseItemLineType? = nil,
        formats: BulkPhoneValidateResponseItemFormats? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rawInput = try container.decodeIfPresent(BulkPhoneValidateResponseItemRawInput.self, forKey: .rawInput)
        ...
        self.lineType = try container.decodeIfPresent(BulkPhoneValidateResponseItemLineType.self, forKey: .lineType)
        self.formats = try container.decodeIfPresent(BulkPhoneValidateResponseItemFormats.self, forKey: .formats)
