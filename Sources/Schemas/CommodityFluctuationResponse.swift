...
public struct CommodityFluctuationResponse: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        timestamp: Double,
        rates: [String: Double],
        metadata: [String: CommodityFluctuationResponseMetadataValue],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.metadata = try container.decode([String: CommodityFluctuationResponseMetadataValue].self, forKey: .metadata)
