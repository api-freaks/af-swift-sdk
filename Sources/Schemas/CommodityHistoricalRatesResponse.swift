...
public struct CommodityHistoricalRatesResponse: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        timestamp: Double,
        rates: [String: Double],
        metadata: [String: CommodityHistoricalRatesResponseMetadataValue],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.metadata = try container.decode([String: CommodityHistoricalRatesResponseMetadataValue].self, forKey: .metadata)
