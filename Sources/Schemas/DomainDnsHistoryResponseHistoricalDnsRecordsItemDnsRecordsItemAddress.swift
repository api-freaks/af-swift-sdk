...
public struct DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAddress: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAddressDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAddressDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        address: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAddressDnsType.self, forKey: .dnsType)
