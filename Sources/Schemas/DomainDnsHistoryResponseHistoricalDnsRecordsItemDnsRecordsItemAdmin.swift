...
public struct DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdmin: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdminDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdminDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        admin: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdminDnsType.self, forKey: .dnsType)
