...
public struct DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemOne: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemOneDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemOneDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        target: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemOneDnsType.self, forKey: .dnsType)
