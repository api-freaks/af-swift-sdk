...
public struct DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemStrings: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemStringsDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemStringsDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        strings: [String],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemStringsDnsType.self, forKey: .dnsType)
