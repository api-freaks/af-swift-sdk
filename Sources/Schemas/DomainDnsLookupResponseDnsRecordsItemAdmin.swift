...
public struct DomainDnsLookupResponseDnsRecordsItemAdmin: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsLookupResponseDnsRecordsItemAdminDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsLookupResponseDnsRecordsItemAdminDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        admin: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsLookupResponseDnsRecordsItemAdminDnsType.self, forKey: .dnsType)
