...
public struct DomainDnsLookupResponseDnsRecordsItemPriority: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsLookupResponseDnsRecordsItemPriorityDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsLookupResponseDnsRecordsItemPriorityDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        target: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsLookupResponseDnsRecordsItemPriorityDnsType.self, forKey: .dnsType)
