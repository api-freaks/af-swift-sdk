...
public struct DomainDnsLookupResponseDnsRecordsItemSingleName: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsLookupResponseDnsRecordsItemSingleNameDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsLookupResponseDnsRecordsItemSingleNameDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        singleName: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsLookupResponseDnsRecordsItemSingleNameDnsType.self, forKey: .dnsType)
