...
public struct DomainDnsLookupResponseDnsRecordsItemStrings: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsLookupResponseDnsRecordsItemStringsDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsLookupResponseDnsRecordsItemStringsDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        strings: [String],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsLookupResponseDnsRecordsItemStringsDnsType.self, forKey: .dnsType)
