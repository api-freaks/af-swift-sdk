...
public struct DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAddress: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAddressDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAddressDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        address: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAddressDnsType.self, forKey: .dnsType)
