...
public struct DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdmin: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdminDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdminDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        admin: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdminDnsType.self, forKey: .dnsType)
