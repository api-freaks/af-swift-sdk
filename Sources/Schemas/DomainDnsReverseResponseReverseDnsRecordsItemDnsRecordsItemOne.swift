...
public struct DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemOne: Codable, Hashable, Sendable {
    public let name: String
    public let type: Int
    public let dnsType: DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemOneDnsType
    public let ttl: Int
    ...
    public init(
        name: String,
        type: Int,
        dnsType: DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemOneDnsType,
        ttl: Int,
        rawText: String,
        rRsetType: Int,
        target: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dnsType = try container.decode(DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemOneDnsType.self, forKey: .dnsType)
