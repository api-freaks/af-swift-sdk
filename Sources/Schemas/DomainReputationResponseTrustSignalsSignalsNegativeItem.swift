...
public struct DomainReputationResponseTrustSignalsSignalsNegativeItem: Codable, Hashable, Sendable {
    /// Signal code identifier (e.g. valid_ssl, dmarc_missing).
    public let code: String
    /// Weight assigned to the signal.
    public let weight: Int
    /// Polarity of the signal.
    public let polarity: DomainReputationResponseTrustSignalsSignalsNegativeItemPolarity
    ...
    public init(
        code: String,
        weight: Int,
        polarity: DomainReputationResponseTrustSignalsSignalsNegativeItemPolarity,
        category: String,
        evidence: String,
        confidence: Float,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.polarity = try container.decode(DomainReputationResponseTrustSignalsSignalsNegativeItemPolarity.self, forKey: .polarity)
