...
public struct DomainSslChainLookupResponseSslCertificatesItem: Codable, Hashable, Sendable {
    ...
    public let subject: DomainSslChainLookupResponseSslCertificatesItemSubject
    public let issuer: DomainSslChainLookupResponseSslCertificatesItemIssuer
    public let publicKey: DomainSslChainLookupResponseSslCertificatesItemPublicKey
    public let extensions: DomainSslChainLookupResponseSslCertificatesItemExtensions
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.subject = try container.decode(DomainSslChainLookupResponseSslCertificatesItemSubject.self, forKey: .subject)
        self.issuer = try container.decode(DomainSslChainLookupResponseSslCertificatesItemIssuer.self, forKey: .issuer)
        self.publicKey = try container.decode(DomainSslChainLookupResponseSslCertificatesItemPublicKey.self, forKey: .publicKey)
        self.extensions = try container.decode(DomainSslChainLookupResponseSslCertificatesItemExtensions.self, forKey: .extensions)
