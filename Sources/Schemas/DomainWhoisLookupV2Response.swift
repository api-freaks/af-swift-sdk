...
public struct DomainWhoisLookupV2Response: Codable, Hashable, Sendable {
    ...
    public let domainRegistered: DomainWhoisLookupV2ResponseDomainRegistered
    ...
    public let domainRegistrar: DomainWhoisLookupV2ResponseDomainRegistrar?
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    public let resellerContact: DomainWhoisLookupV2ResponseResellerContact?
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    public let registrantContact: DomainWhoisLookupV2ResponseRegistrantContact?
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    public let administrativeContact: DomainWhoisLookupV2ResponseAdministrativeContact?
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    public let technicalContact: DomainWhoisLookupV2ResponseTechnicalContact?
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    public let billingContact: DomainWhoisLookupV2ResponseBillingContact?
    /// Registrar's abuse-reporting contact.
    public let abuseContact: DomainWhoisLookupV2ResponseAbuseContact?
    /// Domain eligibility information (populated for TLDs with registrant eligibility requirements, e.g. .eu).
    public let eligibilityInfo: DomainWhoisLookupV2ResponseEligibilityInfo?
    ...
    public let registryData: DomainWhoisLookupV2ResponseRegistryData?
    ...
    public init(
        ...
        domainRegistered: DomainWhoisLookupV2ResponseDomainRegistered,
        secureDns: Bool? = nil,
        domainHandle: String? = nil,
        createDate: CalendarDate? = nil,
        updateDate: CalendarDate? = nil,
        expiryDate: CalendarDate? = nil,
        domainRegistrar: DomainWhoisLookupV2ResponseDomainRegistrar? = nil,
        resellerContact: DomainWhoisLookupV2ResponseResellerContact? = nil,
        registrantContact: DomainWhoisLookupV2ResponseRegistrantContact? = nil,
        administrativeContact: DomainWhoisLookupV2ResponseAdministrativeContact? = nil,
        technicalContact: DomainWhoisLookupV2ResponseTechnicalContact? = nil,
        billingContact: DomainWhoisLookupV2ResponseBillingContact? = nil,
        abuseContact: DomainWhoisLookupV2ResponseAbuseContact? = nil,
        eligibilityInfo: DomainWhoisLookupV2ResponseEligibilityInfo? = nil,
        nameServers: [String]? = nil,
        domainStatus: [String]? = nil,
        whoisRawDomain: String? = nil,
        registryData: DomainWhoisLookupV2ResponseRegistryData? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.domainRegistered = try container.decode(DomainWhoisLookupV2ResponseDomainRegistered.self, forKey: .domainRegistered)
        ...
        self.domainRegistrar = try container.decodeIfPresent(DomainWhoisLookupV2ResponseDomainRegistrar.self, forKey: .domainRegistrar)
        self.resellerContact = try container.decodeIfPresent(DomainWhoisLookupV2ResponseResellerContact.self, forKey: .resellerContact)
        self.registrantContact = try container.decodeIfPresent(DomainWhoisLookupV2ResponseRegistrantContact.self, forKey: .registrantContact)
        self.administrativeContact = try container.decodeIfPresent(DomainWhoisLookupV2ResponseAdministrativeContact.self, forKey: .administrativeContact)
        self.technicalContact = try container.decodeIfPresent(DomainWhoisLookupV2ResponseTechnicalContact.self, forKey: .technicalContact)
        self.billingContact = try container.decodeIfPresent(DomainWhoisLookupV2ResponseBillingContact.self, forKey: .billingContact)
        self.abuseContact = try container.decodeIfPresent(DomainWhoisLookupV2ResponseAbuseContact.self, forKey: .abuseContact)
        self.eligibilityInfo = try container.decodeIfPresent(DomainWhoisLookupV2ResponseEligibilityInfo.self, forKey: .eligibilityInfo)
        ...
        self.registryData = try container.decodeIfPresent(DomainWhoisLookupV2ResponseRegistryData.self, forKey: .registryData)
