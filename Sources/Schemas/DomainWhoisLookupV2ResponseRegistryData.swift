...
public struct DomainWhoisLookupV2ResponseRegistryData: Codable, Hashable, Sendable {
    ...
    public let domainRegistered: DomainWhoisLookupV2ResponseRegistryDataDomainRegistered?
    ...
    public let domainRegistrar: DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar?
    ...
    public init(
        ...
        domainRegistrar: DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.domainRegistrar = try container.decodeIfPresent(DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar.self, forKey: .domainRegistrar)
