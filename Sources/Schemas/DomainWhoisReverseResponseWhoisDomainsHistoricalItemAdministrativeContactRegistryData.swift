...
public struct DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryData: Codable, Hashable, Sendable {
    public let domainName: String?
    public let queryTime: Date?
    public let whoisServer: String?
    public let domainRegistered: DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistered?
    ...
    public let domainRegistrar: DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistrar?
    ...
    public init(
        ...
        domainRegistered: DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistered? = nil,
        ...
        domainRegistrar: DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistrar? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.domainRegistered = try container.decodeIfPresent(DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistered.self, forKey: .domainRegistered)
        ...
        self.domainRegistrar = try container.decodeIfPresent(DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistrar.self, forKey: .domainRegistrar)
