...
public struct EmailValidateResponse: Codable, Hashable, Sendable {
    public let success: Bool
    public let email: String
    public let name: String?
    public let reason: String?
    public let validEmail: EmailValidateResponseValidEmail
    ...
    public init(
        ...
        name: String? = nil,
        reason: String? = nil,
        validEmail: EmailValidateResponseValidEmail,
        validSyntax: Bool,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.validEmail = try container.decode(EmailValidateResponseValidEmail.self, forKey: .validEmail)
