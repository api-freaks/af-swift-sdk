...
public struct GeocoderSearchResponseItem: Codable, Hashable, Sendable {
    ...
    public let poi: [GeocoderSearchResponseItemPoiItem]?
    /// Street or road name.
    ...
    public init(
        ...
        category: String? = nil,
        type: String? = nil,
        poi: [GeocoderSearchResponseItemPoiItem]? = nil,
        street: String? = nil,
        area: String? = nil,
        postcode: String? = nil,
        city: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.poi = try container.decodeIfPresent([GeocoderSearchResponseItemPoiItem].self, forKey: .poi)
