...
public struct GeolocationLookupV2ResponseTimeZone: Codable, Hashable, Sendable {
    ...
    public let dstStart: GeolocationLookupV2ResponseTimeZoneDstStart?
    /// DST transition details (used for both the DST start and DST end transitions).
    public let dstEnd: GeolocationLookupV2ResponseTimeZoneDstEnd?
    ...
    public init(
        ...
        dstStart: GeolocationLookupV2ResponseTimeZoneDstStart? = nil,
        dstEnd: GeolocationLookupV2ResponseTimeZoneDstEnd? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.dstStart = try container.decodeIfPresent(GeolocationLookupV2ResponseTimeZoneDstStart.self, forKey: .dstStart)
        self.dstEnd = try container.decodeIfPresent(GeolocationLookupV2ResponseTimeZoneDstEnd.self, forKey: .dstEnd)
